...
public class BattleModeCard_AT_WX02_A08 : BattleModeCard
{
    ...
    public EnumController.Trigger trigger = EnumController.Trigger.SHOT;
    ...
    public EnumController.CardNo cardNo = EnumController.CardNo.AT_WX02_A08;
    public string name = "Memory of a Memory";
    public int power = -1;
