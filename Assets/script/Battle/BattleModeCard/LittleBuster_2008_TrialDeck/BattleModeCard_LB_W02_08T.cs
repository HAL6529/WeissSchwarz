...
public class BattleModeCard_LB_W02_08T : BattleModeCard
{
    ...
    public List<EnumController.Attribute> attribute = new List<EnumController.Attribute>() { EnumController.Attribute.Marble };
    public EnumController.CardNo cardNo = EnumController.CardNo.LB_W02_08T;
    public string name = "ÅgÉGÉvÉçÉìÅhótóØâ¿";
