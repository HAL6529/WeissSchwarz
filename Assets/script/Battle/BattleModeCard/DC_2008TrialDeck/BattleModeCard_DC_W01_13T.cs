...
public class BattleModeCard_DC_W01_13T : BattleModeCard
{
    ...
    public EnumController.CardNo cardNo = EnumController.CardNo.DC_W01_13T;
    public string name = "HM-A06Œ^ ƒ~ƒiƒc";
    public int power = 1000;
    public bool isCounter = false;
    public bool isGreatPerformance = false;
    public EffectAbstract m_EffectAbstract = new Effect_DC_W01_13T();
}
