...
public class BattleModeCard_P3_S01_16T : BattleModeCard
{
    ...
    public List<EnumController.Attribute> attribute = new List<EnumController.Attribute>() { EnumController.Attribute.StudentCouncil, EnumController.Attribute.Glasses };
    public EnumController.CardNo cardNo = EnumController.CardNo.P3_S01_16T;
    public string name = "ïöå© êÁêq";
