...
{
    public BattleModeCard_P3_S01_10T()
    {
        this.level = 1;
        this.cost = 1;
        this.soul = 1;
        ...
        this.cardNo = EnumController.CardNo.P3_S01_10T;
        this.cardName = "天田＆ネメシス";
        this.power = 6000;
        this.isCounter = false;
        this.isGreatPerformance = false;
        this.Explanation1 = stringValues.P3_S01_10T_Explanation1;
        this.Explanation2 = "";
        this.Explanation3 = "";
        this.Explanation4 = "";
        this.Explanation5 = "";
