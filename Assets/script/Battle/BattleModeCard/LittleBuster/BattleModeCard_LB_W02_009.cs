...
public class BattleModeCard_LB_W02_009 : BattleModeCard
{
    public BattleModeCard_LB_W02_009()
    {
        ...
        this.cardName = "“ウェディングドレス”鈴";
        this.power = 3500;
        this.isCounter = false;
        this.isGreatPerformance = false;
        this.Explanation1 = stringValues.LB_W02_009_Explanation1;
        this.Explanation2 = stringValues.LB_W02_009_Explanation2;
        this.Explanation3 = stringValues.LB_W02_009_Explanation3;
        this.Explanation4 = "";
        this.Explanation5 = "";
