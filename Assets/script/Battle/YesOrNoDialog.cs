...
public class YesOrNoDialog : MonoBehaviour
{
    ...
    private void SetText()
    {
        ...
        switch (m_YesOrNoDialogParamater)
        {
            ...
            case EnumController.YesOrNoDialogParamater.CONFIRM_Effect_EnemyReverseIfEnemyLowerLevelWhenThisReverse:
                str = stringValues.YesOrNoDialog_CONFIRM_Effect_EnemyReverseIfEnemyLowerLevelWhenThisReverse;
                break;
            case EnumController.YesOrNoDialogParamater.CONFIRM_Effect_ThisPutStockWhenEnemyReverse:
                str = stringValues.YesOrNoDialog_CONFIRM_Effect_ThisPutStockWhenEnemyReverse;
                break;
            ...
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_BOND_FOR_HAND_TO_FIELD:
                switch (m_BattleModeCard.GetCardNo())
                {
                    ...
                    case EnumController.CardNo.LB_W02_078:
                        sulvageCardName = stringValues.LB_W02_080_NAME;
                        cost = 1;
                        break;
                    default:
                        sulvageCardName = "";
            ...
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_P3_S01_004:
                ...
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_P3_S01_006:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_P3_S01_06;
                break;
            ...
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_034:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_034;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_038:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_038;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_054:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_054;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_055:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_055;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_077_1:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_077_1;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_077_2:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_077_2;
                break;
            ...
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_083:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_083;
                break;
            case EnumController.YesOrNoDialogParamater.COST_CONFIRM_LB_W02_088:
                str = stringValues.YesOrNoDialog_COST_CONFIRM_LB_W02_088;
                break;
    ...
    public void onYesClick()
    {
        switch (m_YesOrNoDialogParamater)
        {
            ...
            case EnumController.YesOrNoDialogParamater.CONFIRM_Effect_ThisPutStockWhenEnemyReverse:
                m_EventAnimationManager.Effect_ThisPutStockWhenEnemyReverseAnimationStart(m_BattleModeCard, m_EffectAbstract);
                m_BattleStrix.EventAnimation(m_BattleModeCard, m_GameManager.isFirstAttacker);
                break;
