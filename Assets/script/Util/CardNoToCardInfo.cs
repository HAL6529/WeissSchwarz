...
namespace CardNoToCardInfo
{
    ...
    {   
        public BattleCardInfo cardNoToCardInfo(EnumController.CardNo cardNo)
        {
            switch (cardNo)
            {
                // レベル,コスト,色,トリガー,種類,特徴1,特徴2,特徴3,カードナンバー,カードの名前,ゾーン,カウンターかどうか
                case EnumController.CardNo.AT_WX02_A01:
                    return new BattleCardInfo(0, 0, EnumController. CardColor.YELLOW, EnumController.Trriger.NONE, EnumController.Type.CHARACTER,
                ...
                case EnumController.CardNo.AT_WX02_A03:
                    return new BattleCardInfo(1, 0, EnumController.CardColor.YELLOW, EnumController.Trriger.NONE, EnumController.Type.CHARACTER,
                                                EnumController.Attribute.Ooo, EnumController.Attribute.Hero, EnumController.Attribute.NONE,
